...
import com.example.igor.model.Category;
import com.example.igor.model.Record;
import com.example.igor.utils.DataBaseHelper;
import com.example.igor.utils.StatisticUtils;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void printGraphic() {
        ...
        VALUES = StatisticUtils.getTimeAllCatogory(dateStart, dateEnd);
    ...
    public void onClickDeleteCategory(View view) {
        ...
        add.setPositiveButton("Да", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                DataBaseHelper.getInstance().getWritableDatabase().execSQL(insertQuery);
    ...
    public void updateTopCount() {
        List<String> list = StatisticUtils.getTopCount(dateStart, dateEnd);
        String s = "";
        for (String ss : list) {
            s += ss + "\n";
        }
    ...
    public void updateTopTime() {
        List<String> list = StatisticUtils.getTopTime(dateStart, dateEnd);
        String s = "";
        for (String ss : list)
            s += ss + "\n";
        topTime.setText(s);
    ...
    public void updateTopSum() {
        ...
        String sum = StatisticUtils.getSumTime(cat, dateStart, dateEnd);
        topSum.setText(sum);
    }
